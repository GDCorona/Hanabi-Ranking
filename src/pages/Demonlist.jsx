...
const opinionChangelogData = [
    ...
    { date: "July 17, 2026", desc: "Caution placed at #20, Marathon out of top 30." }
]; 
const aredlChangelogData = [
    ...
    { date: "July 10, 2026", desc: "Brain Power placed at #26, Sky Tech out of top 30." },
    { date: "July 17, 2026", desc: "Caution placed at #24, EXTREME MEMORY MIX out of top 30." }
];
